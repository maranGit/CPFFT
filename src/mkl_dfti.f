c===============================================================================
c Copyright 2002-2015 Intel Corporation All Rights Reserved.
c
...
c in any way without Intel's prior express written permission.  No license under
c any patent,  copyright or other  intellectual property rights  in the Material
c is granted to  or  conferred  upon  you,  either   expressly,  by implication,
c inducement,  estoppel  or  otherwise.  Any  license   under such  intellectual
c property rights must be express and approved by Intel in writing.
c
c Unless otherwise agreed by Intel in writing,  you may not remove or alter this
c notice or  any  other  notice   embedded  in  Materials  by  Intel  or Intel's
c suppliers or licensors in any way.
c===============================================================================

c Content:
c    Intel(R) Math Kernel Library (MKL)
c    Discrete Fourier Transform Interface (DFTI)
c*****************************************************************************
...
c======================================================================
c These real type kind parameters are not for direct use
c======================================================================
...
c======================================================================
c Descriptor configuration parameters [default values in brackets]
c======================================================================

c Domain for forward transform. No default value
        INTEGER, PARAMETER :: DFTI_FORWARD_DOMAIN = 0

c Dimensionality, or rank. No default value
        INTEGER, PARAMETER :: DFTI_DIMENSION = 1

c Length(s) of transform. No default value
        INTEGER, PARAMETER :: DFTI_LENGTHS = 2

c Floating point precision. No default value
        INTEGER, PARAMETER :: DFTI_PRECISION = 3

c Scale factor for forward transform [1.0]
        INTEGER, PARAMETER :: DFTI_FORWARD_SCALE = 4

c Scale factor for backward transform [1.0]
        INTEGER, PARAMETER :: DFTI_BACKWARD_SCALE = 5

c Exponent sign for forward transform [DFTI_NEGATIVE]
c INTEGER, PARAMETER :: DFTI_FORWARD_SIGN = 6 ! NOT IMPLEMENTED

c Number of data sets to be transformed [1]
        INTEGER, PARAMETER :: DFTI_NUMBER_OF_TRANSFORMS = 7

c Storage of finite complex-valued sequences in complex domain
c [DFTI_COMPLEX_COMPLEX]
        INTEGER, PARAMETER :: DFTI_COMPLEX_STORAGE = 8

c Storage of finite real-valued sequences in real domain
c [DFTI_REAL_REAL]
        INTEGER, PARAMETER :: DFTI_REAL_STORAGE = 9

c Storage of finite complex-valued sequences in conjugate-even
c domain [DFTI_COMPLEX_REAL]
        INTEGER, PARAMETER :: DFTI_CONJUGATE_EVEN_STORAGE = 10

c Placement of result [DFTI_INPLACE]
        INTEGER, PARAMETER :: DFTI_PLACEMENT = 11

c Generalized strides for input data layout
c [tigth, col-major for Fortran]
        INTEGER, PARAMETER :: DFTI_INPUT_STRIDES = 12

c Generalized strides for output data layout
c [tigth, col-major for Fortran]
        INTEGER, PARAMETER :: DFTI_OUTPUT_STRIDES = 13

c Distance between first input elements for multiple transforms [0]
        INTEGER, PARAMETER :: DFTI_INPUT_DISTANCE = 14

c Distance between first output elements for multiple transforms [0]
        INTEGER, PARAMETER :: DFTI_OUTPUT_DISTANCE = 15

c Effort spent in initialization [DFTI_MEDIUM]
c INTEGER, PARAMETER :: DFTI_INITIALIZATION_EFFORT = 16 ! NOT IMPLEMENTED

c Use of workspace during computation [DFTI_ALLOW]
        INTEGER, PARAMETER :: DFTI_WORKSPACE = 17

c Ordering of the result [DFTI_ORDERED]
        INTEGER, PARAMETER :: DFTI_ORDERING = 18

c Possible transposition of result [DFTI_NONE]
        INTEGER, PARAMETER :: DFTI_TRANSPOSE = 19

c User-settable descriptor name [""]
        INTEGER, PARAMETER :: DFTI_DESCRIPTOR_NAME = 20

c Packing format for DFTI_COMPLEX_REAL storage of finite
c conjugate-even sequences [DFTI_CCS_FORMAT]
        INTEGER, PARAMETER :: DFTI_PACKED_FORMAT = 21

c Commit status of the descriptor. Read-only parameter
        INTEGER, PARAMETER :: DFTI_COMMIT_STATUS = 22

c Version string for this DFTI implementation. Read-only parameter
        INTEGER, PARAMETER :: DFTI_VERSION = 23

c Ordering of the forward transform. Read-only parameter
c INTEGER, PARAMETER :: DFTI_FORWARD_ORDERING = 24 ! NOT IMPLEMENTED

c Ordering of the backward transform. Read-only parameter
c INTEGER, PARAMETER :: DFTI_BACKWARD_ORDERING = 25 ! NOT IMPLEMENTED

c Number of user threads that share the descriptor [1]
        INTEGER, PARAMETER :: DFTI_NUMBER_OF_USER_THREADS = 26

c Limit the number of threads used by this descriptor [0 = don't care]
        INTEGER, PARAMETER :: DFTI_THREAD_LIMIT = 27

c======================================================================
c Values of the descriptor configuration parameters
c======================================================================

c DFTI_COMMIT_STATUS
        INTEGER, PARAMETER :: DFTI_COMMITTED = 30
        INTEGER, PARAMETER :: DFTI_UNCOMMITTED = 31

c DFTI_FORWARD_DOMAIN
        INTEGER, PARAMETER :: DFTI_COMPLEX = 32
        INTEGER, PARAMETER :: DFTI_REAL = 33
c INTEGER, PARAMETER :: DFTI_CONJUGATE_EVEN = 34 ! NOT IMPLEMENTED

c DFTI_PRECISION
        INTEGER, PARAMETER :: DFTI_SINGLE = 35
        INTEGER, PARAMETER :: DFTI_DOUBLE = 36

c DFTI_PRECISION for reduced size of statically linked application.
c Recommended use: modify statement 'USE MKL_DFTI' in your program,
c so that it reads as either of:
c USE MKL_DFTI, FORGET=>DFTI_SINGLE, DFTI_SINGLE=>DFTI_SINGLE_R
c USE MKL_DFTI, FORGET=>DFTI_DOUBLE, DFTI_DOUBLE=>DFTI_DOUBLE_R
c where word 'FORGET' can be any name not used in the program.
        REAL(DFTI_SPKP), PARAMETER :: DFTI_SINGLE_R = 35
        REAL(DFTI_DPKP), PARAMETER :: DFTI_DOUBLE_R = 36

c DFTI_FORWARD_SIGN
c INTEGER, PARAMETER :: DFTI_NEGATIVE = 37 ! NOT IMPLEMENTED
c INTEGER, PARAMETER :: DFTI_POSITIVE = 38 ! NOT IMPLEMENTED

c DFTI_COMPLEX_STORAGE and DFTI_CONJUGATE_EVEN_STORAGE
...
c DFTI_INITIALIZATION_EFFORT
c INTEGER, PARAMETER :: DFTI_LOW = 45 ! NOT IMPLEMENTED
c INTEGER, PARAMETER :: DFTI_MEDIUM = 46 ! NOT IMPLEMENTED
c INTEGER, PARAMETER :: DFTI_HIGH = 47 ! NOT IMPLEMENTED

c DFTI_ORDERING
        INTEGER, PARAMETER :: DFTI_ORDERED = 48
        INTEGER, PARAMETER :: DFTI_BACKWARD_SCRAMBLED = 49
c INTEGER, PARAMETER :: DFTI_FORWARD_SCRAMBLED  = 50 ! NOT IMPLEMENTED

c Allow/avoid certain usages
...
c DFTI_PACKED_FORMAT
c (for storing congugate-even finite sequence in real array)
...
c Maximum length of error string
        INTEGER, PARAMETER :: DFTI_MAX_MESSAGE_LENGTH = 80

c Maximum length of user-settable descriptor name
        INTEGER, PARAMETER :: DFTI_MAX_NAME_LENGTH = 10

c Maximum length of MKL version string
...
c     overloading of DftiCreateDescriptor for 1D DFT
      FUNCTION dfti_create_descriptor_1d(desc, precision, domain, dim,
     &                                    length)
       USE MKL_DFT_TYPE
...
c     overloading of DftiCreateDescriptor for nD DFT
      FUNCTION dfti_create_descriptor_highd(desc, precision, domain,
     &                                       dim,length)
       USE MKL_DFT_TYPE
...
c     overloading of DftiCreateDescriptor for SP 1D DFT
c     second parameter (precision) should be any REAL*4 value
c     for dispatching during compile time
...
c     overloading of DftiCreateDescriptor for SP nD DFT
c     second parameter (precision) should be any REAL*4 value
c     for dispatching during compile time
...
c     overloading of DftiCreateDescriptor for DP 1D DFT
c     second parameter (precision) should be any REAL*8 value
c     for dispatching during compile time
...
c     overloading of DftiCreateDescriptor for DP nD DFT
c     second parameter (precision) should be any REAL*8 value
c     for dispatching during compile time
...
c     overloading of DftiSetValue for integer value
...
c     overloading of DftiSetValue for SP value
...
c     overloading of DftiSetValue for DP value
...
c     overloading of DftiSetValue for integer vector
...
c     overloading of DftiSetValue for char vector
...
c     overloading of DftiGetValue for integer value
...
c     overloading of DftiGetValue for SP value
...
c     overloading of DftiGetValue for DP value
...
c     overloading of DftiGetValue for integer vector
...
c     overloading of DftiGetValue for char vector
...
c     overloading of DftiComputeForward for SP R2C DFT (inplace)
...
c     overloading of DftiComputeForward for SP C2C DFT (inplace)
...
c     overloading of DftiComputeForward for SP C2C DFT (inplace, split complex)
...
c     overloading of DftiComputeForward for SP R2C DFT (out-of-place)
...
c     overloading of DftiComputeForward for SP C2C DFT (out-of-place)
...
c     overloading of DftiComputeForward for SP C2C DFT (out-of-place, split
c     complex)
      FUNCTION dfti_compute_forward_ssss(desc,sSrcRe,sSrcIm,sDstRe,
     &                                    sDstIm)
       USE MKL_DFT_TYPE
...
c     overloading of DftiComputeForward for DP R2C DFT (inplace)
...
c     overloading of DftiComputeForward for DP C2C DFT (inplace)
...
c     overloading of DftiComputeForward for DP C2C DFT (inplace, split complex)
...
c     overloading of DftiComputeForward for DP R2C DFT (out-of-place)
...
c     overloading of DftiComputeForward for DP C2C DFT (out-of-place)
...
c     overloading of DftiComputeForward for DP C2C DFT (out-of-place, split
c     complex)
      FUNCTION dfti_compute_forward_dddd(desc,dSrcRe,dSrcIm,dDstRe,
     &                                    dDstIm)
       USE MKL_DFT_TYPE
...
c     overloading of DftiComputeBackward for SP C2R DFT (inplace)
...
c     overloading of DftiComputeBackward for SP C2C DFT (inplace)
...
c     overloading of DftiComputeBackward for SP C2C DFT (inplace, split complex)
...
c     overloading of DftiComputeBackward for SP C2R DFT (out-of-place)
...
c     overloading of DftiComputeBackward for SP C2C DFT (out-of-place)
...
c     overloading of DftiComputeBackward for SP C2C DFT (out-of-place, split
c     complex)
      FUNCTION dfti_compute_backward_ssss(desc,sSrcRe,sSrcIm,sDstRe,
     &                                     sDstIm)
       USE MKL_DFT_TYPE
...
c     overloading of DftiComputeBackward for DP C2R DFT (inplace)
...
c     overloading of DftiComputeBackward for DP C2C DFT (inplace)
...
c     overloading of DftiComputeBackward for DP C2C DFT (inplace, split complex)
...
c     overloading of DftiComputeBackward for DP C2R DFT (out-of-place)
...
c     overloading of DftiComputeBackward for DP C2C DFT (out-of-place)
...
c     overloading of DftiComputeBackward for DP C2C DFT (out-of-place, split
c     complex)
      FUNCTION dfti_compute_backward_dddd(desc,dSrcRe,dSrcIm,dDstRe,
     &                                     dDstIm)
       USE MKL_DFT_TYPE
